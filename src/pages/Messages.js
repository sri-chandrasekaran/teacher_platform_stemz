...
//   const [error, setError] = useState(''); // Error message for duplicate or empty group name
...
//     setMessages({ ...messages, [groupName]: [] }); // Initialize message history for the new group
//     setShowCreateGroup(false);
//     setSelectedStudents([]);
//     setGroupName(''); // Clear the group name field
//     setSelectedStudent(groupName); // Optionally select the new group after creation
